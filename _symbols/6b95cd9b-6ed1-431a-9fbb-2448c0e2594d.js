// NavBar - Updated December 30, 2024
function noop() { }
...
function create_if_block(ctx) {
	let a;
	let t_value = /*item*/ ctx[7].link.label + "";
	let t;
	let a_href_value;
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*item*/ ctx[7].link.url);
			attr(a, "class", "link");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*items*/ 4 && t_value !== (t_value = /*item*/ ctx[7].link.label + "")) set_data(t, t_value);

			if (dirty & /*items*/ 4 && a_href_value !== (a_href_value = /*item*/ ctx[7].link.url)) {
...
// (39:6) {#each items as item}
function create_each_block_1(ctx) {
	let li;
	let if_block = /*item*/ ctx[7].link && create_if_block(ctx);
...
// (47:6) {#each flags as flag}
function create_each_block(ctx) {
	let a;
	let icon;
	let p;
	let t_value = /*flag*/ ctx[4].label + "";
	let t;
	let a_href_value;
	let current;
	...
	return {
		...
		h() {
			attr(p, "class", "svelte-114yyda");
			attr(a, "href", a_href_value = /*flag*/ ctx[4].link);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*flags*/ 2) icon_changes.icon = /*flag*/ ctx[4].country;
			icon.$set(icon_changes);
			if ((!current || dirty & /*flags*/ 2) && t_value !== (t_value = /*flag*/ ctx[4].label + "")) set_data(t, t_value);

			if (!current || dirty & /*flags*/ 2 && a_href_value !== (a_href_value = /*flag*/ ctx[4].link)) {
				attr(a, "href", a_href_value);
			}
		},
		i(local) {
...
function create_fragment(ctx) {
	...
	let t1;
	let current;
	let if_block = /*logo*/ ctx[0] && create_if_block_1(ctx);
	...
	return {
		...
		h() {
			attr(ul, "class", "svelte-114yyda");
			attr(nav, "class", "svelte-114yyda");
...
function instance($$self, $$props, $$invalidate) {
	...
	return [logo, flags, items, props];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 3, logo: 0, flags: 1, items: 2 });
	}
}
