// Footer - Updated December 30, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*privacypolicy*/ ctx[1].link);
			attr(a, "class", "svelte-gspc85");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*privacypolicy*/ 2 && a_href_value !== (a_href_value = /*privacypolicy*/ ctx[1].link)) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(div0, "class", "content-wrapper svelte-gspc85");
			attr(div1, "id", "copyright");
			attr(div2, "class", "footer svelte-gspc85");
			attr(div3, "class", "page-container svelte-gspc85");
		},
		m(target, anchor) {
